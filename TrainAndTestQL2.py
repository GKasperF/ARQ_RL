...
test_file = 'Data/Agent_QTable_results_Simple_GE_Example_Dict.pickle'
...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, alpha, epsilon, Channel, M):
    ...
    model_file = 'Model_Simple_GE_Example_QTable'+string_alpha+'.pickle'
...
with open('Data/AgentRLresults_QTable_Simple_GE_Example.pickle', 'wb') as f:
