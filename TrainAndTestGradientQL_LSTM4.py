...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, epsilon, batch, Channel):
    ...
    model_file = 'ModelCNN_LSTM_Batch_GE_Isolated'+string_alpha+'.pickle'
    t0 = time.time()
    ...
    with open('Data/AgentCNN_LSTM_RLresultsTestBatch_GE_Isolated.pickle', 'ab') as f:
...
with open('Data/AgentCNN_LSTM_RLresultsTestBatch_GE_Isolated.pickle', 'wb') as f:
