...
test_file = 'Data/AgentCNN_LSTM_DRQN_LongerDeadline_RLresultsTestBatch_GE_Isolated.pickle'
...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, epsilon, batch, Channel):
    ...
    model_file = 'ModelCNN_LSTM_DRQN_Batch_GE_Isolated'+string_alpha+'.pickle'
...
with open('Data/AgentCNN_LSTM_DRQN_RL_All_resultsTestBatch_GE_Isolated.pickle', 'wb') as f:
