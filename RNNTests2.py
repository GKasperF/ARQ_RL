...
with open('Data/SaveLossRNN_GE_Isolated_Batch.pickle', 'rb') as f:
...
#with open('Data/SaveLossRNN_TraceSetRun1_10m.pickle', 'wb') as f:
 # torch.save(save_loss, f)

with open('Data/RNN_Model_GE_Isolated_Batch.pickle', 'rb') as f:
