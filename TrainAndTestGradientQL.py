...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, epsilon, batch, Channel):
    ...
    model_file = 'ModelCNNBatch_LargerMemory'+string_alpha+'.pickle'
    t0 = time.time()
    ...
    with open('Data/AgentCNNRLresultsTestBatch_LargerMemory.pickle', 'ab') as f:
...
with open('Data/AgentCNNRLresultsTestBatch_LargerMemory.pickle', 'wb') as f:
