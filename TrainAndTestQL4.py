...
test_file = 'Data/Agent_QTable_results_Fritchman_Example_Dict.pickle'
...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, alpha, epsilon, Channel, M):
    ...
    model_file = 'Model_Fritchman_Example_QTable'+string_alpha+'.pickle'
...
Channel = Envs.Fritchman(0.1, 0.5, 0.05, 4)
...
with open('Data/AgentRLresults_QTable_Frtichman_Example.pickle', 'wb') as f:
