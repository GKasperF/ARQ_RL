...
test_file = 'Data/AgentCNN_LSTM_RLresultsTestBatch_SimpleGE.pickle'
...
Channel = Envs.GilbertElliott(0.25, 0.25, 0.0, 1, batches)
...
with open('Data/AgentCNN_LSTM_RL_All_resultsTestBatch_SimpleGE.pickle', 'wb') as f:
