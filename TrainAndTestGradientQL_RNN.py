...
test_file = 'Data/AgentCNNRLresults_Iid_Example_RNN_Dict.pickle'
...
with open('Data/Iid_Model_Example.pickle', 'rb') as f:
...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, epsilon, batch, Channel):
    ...
    model_file = 'ModelCNN_Iid_Example_RNN'+string_alpha+'.pickle'
    ...
    with open('Data/AgentCNNRLresults_Iid_Example_RNN2.pickle', 'ab') as f:
...
with open('Data/AgentCNNRLresults_Iid_Example_RNN_Final2.pickle', 'wb') as f:
