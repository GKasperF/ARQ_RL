...
with open('Data/SimpleGE_StateSequence_Tests.pickle', 'rb') as f:
  ChannelModel_Sequence = torch.load(f)
with open('Data/SimpleGE_Sequence_Example_Tests.pickle', 'rb') as f:
...
path = 'Data/ModelCNN_SimpleGE_Example_RNN*.pickle'
for filename in glob.glob(path):
  ...
  try:
    with open('Data/AgentCNNRLResults_MultiPacket_SimpleGE_Example_NotInOrder.pickle', 'wb') as f:
