...
def TrainAndTest(alpha_reward, beta_reward, Tf, Nit, discount_factor, num_episodes, epsilon, batch, Channel):
    ...
    model_file = 'ModelCNN_LSTM_Batch_Fritchman'+string_alpha+'.pickle'
    ...
    with open('Data/AgentCNN_LSTM_RLresultsTestBatch_Fritchman.pickle', 'ab') as f:
...
with open('Data/AgentCNN_LSTM_RLresultsTestBatch_Fritchman.pickle', 'wb') as f:
