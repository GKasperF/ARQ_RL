...
with open('Data/AgentCNNRLresults_GE_Isolated_Example_RNN_Dict.pickle', 'rb') as f:
...
with open('Data/AgentCNN_LSTM_RLresultsTestBatch_GE_Isolated.pickle', 'rb') as f:
